...
/**
 * @OA\Schema(
 *     title="Виды организаций, в отношении которых поступают жалобы",
 *     description="Виды организаций, в отношении которых поступают жалобы",
 *     @OA\Xml(
 *         name="OrganizationComplaintResource"
 *     )
 * )
 */
class OrganizationComplaintResource
{
     ...
     *      example="государственные организации"
     * )
     *
     * @var string
     */
