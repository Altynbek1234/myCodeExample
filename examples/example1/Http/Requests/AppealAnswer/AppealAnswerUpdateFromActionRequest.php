...
class AppealAnswerUpdateFromActionRequest extends FormRequest
{
    /**
    ...
    {
        $appealAnswerId = $this->route('id');
        $appealAnswer = AppealAnswer::find($appealAnswerId);

        return $appealAnswer->stage;
    }
