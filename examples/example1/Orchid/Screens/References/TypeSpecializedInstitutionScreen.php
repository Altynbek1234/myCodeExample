...
class TypeSpecializedInstitutionScreen extends Screen
{
    /**
     * Query data.
     *
    ...
    {
        return [
            'tsiData'  => TypeSpecializedInstitution::all(),
        ];
    }
    ...
    {
        return 'Виды специализированных учреждений';
    }
    ...
    public function layout(): array
    {
        return [
            Layout::table('tsiData', [
                ...
                TD::make('code', 'Код'),
                TD::make('status_id', 'Статус')->render(function (TypeSpecializedInstitution $tsi) {
                    return $tsi->status_id == 1 ? "Активный" : "Неактивный";
                }),
                TD::make('action', "Действия")->render(function (TypeSpecializedInstitution $tsi) {
                    return Group::make([
    ...
    public function asyncGetTSI(TypeSpecializedInstitution $tsi): array
    {
        return [
            'tsiSinglData' => TypeSpecializedInstitution::find($tsi->id)
        ];
    }

    public function create(Request $request): void
    {
        $tsi = new TypeSpecializedInstitution();
    ...
    {
        $tsi = TypeSpecializedInstitution::find($request->tsiSinglData['id']);
