...
class DirectionDocumentScreen extends Screen
{
    ...
    public function layout(): array
    {
        return [
            Layout::table('gData', [
                ...
                TD::make('status_id', 'Статус')->render(function (DirectionDocument $g) {
                    return $g->status_id == 1 ? "Активный" : "Неактивный";
                }),
                TD::make('action', "Действия")->render(function (DirectionDocument $g) {
                    return Group::make([
    ...
    public function asyncGetG(DirectionDocument $g): array
    {
        return [
            'gSinglData' => DirectionDocument::find($g->id)
        ];
    }

    public function create(Request $request): void
    {
        $g = new DirectionDocument();
    ...
    {
        $g = DirectionDocument::find($request->gSinglData['id']);
