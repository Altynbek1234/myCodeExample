...
class TemplatesResolutionsScreen extends Screen
{
    /**
     * Query data.
     *
    ...
    {
        return [
            'gData'  => TemplatesResolutions::all(),
        ];
    }
    ...
    {
        return 'Шаблоны предварительных резолюций';
    }
    ...
    public function layout(): array
    {
        return [
            Layout::table('gData', [
                ...
                TD::make('status_id', 'Статус')->render(function (TemplatesResolutions $g) {
                    return $g->status_id == 1 ? "Активный" : "Неактивный";
                }),
                TD::make('action', "Действия")->render(function (TemplatesResolutions $g) {
                    return Group::make([
    ...
    public function asyncGetG(TemplatesResolutions $g): array
    {
        return [
            'gSinglData' => TemplatesResolutions::find($g->id)
        ];
    }

    public function create(Request $request): void
    {
        $g = new TemplatesResolutions();
    ...
    {
        $g = TemplatesResolutions::find($request->gSinglData['id']);
