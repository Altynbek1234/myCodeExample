...
class PurposeOfMigrantScreen extends Screen
{
    /**
     * Query data.
     *
    ...
    public function layout(): array
    {
        return [
            Layout::table('gData', [
                ...
                TD::make('status_id', 'Статус')->render(function (PurposeOfMigrant $g) {
                    return $g->status_id == 1 ? "Активный" : "Неактивный";
                }),
                TD::make('action', "Действия")->render(function (PurposeOfMigrant $g) {
                    return Group::make([
    ...
    public function asyncGetG(PurposeOfMigrant $g): array
    {
        return [
            'gSinglData' => PurposeOfMigrant::find($g->id)
        ];
    }

    public function create(Request $request): void
    {
        $g = new PurposeOfMigrant();
    ...
    {
        $g = PurposeOfMigrant::find($request->gSinglData['id']);
