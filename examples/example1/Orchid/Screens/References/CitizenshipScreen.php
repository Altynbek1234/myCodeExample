...
class CitizenshipScreen extends Screen
{
    /**
     * Query data.
     *
    ...
    public function layout(): array
    {
        return [
            Layout::table('rrcData', [
                ...
                TD::make('code', 'Код'),
                TD::make('status_id', 'Статус')->render(function (Citizenship $rrc) {
                    return $rrc->status_id == 1 ? "Активный" : "Неактивный";
                }),
                TD::make('action', "Действия")->render(function (Citizenship $rrc) {
                    return Group::make([
    ...
    public function asyncGetRRC(Citizenship $rrc): array
    {
        return [
            'rrcSinglData' => Citizenship::find($rrc->id)
        ];
    }
    ...
    {
        $rrc = Citizenship::find($request->rrcSinglData['id']);
